    ...
    <div class="min-h-screen flex flex-col items-center p-16 bg-gray-100">
        ...
        <div class="w-1/2 mt-6 px-6 py-4 bg-white shadow-md overflow-hidden sm:rounded-lg">
            <form method="POST" action="{{ route('register.store') }}">
                ...
                <!-- Tingkatan Sekolah -->
                <div class="w-full mt-3">
                    <x-input-label for="tingkatan_sekolah" :value="__('Tingkatan Sekolah')" />
                    <select name="tingkatan_sekolah" id="tingkatan_sekolah"
                    ...
                    <x-input-error :messages="$errors->get('tingkatan_sekolah')" class="mt-2" />
                </div>
