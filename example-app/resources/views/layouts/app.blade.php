...
<body class="font-sans antialiased flex">
    <div class="w-3/12 p-10 bg-[#19559A]">
        <h1 class="text-3xl font-blackHanSansRegular text-[#F5F5DC]">EduTrack</h1>
        <ul class="mt-10 flex flex-col gap-y-2">
            <li class="flex hover:bg-[#F5F5DC] hover:text-[#19559A] px-4 py-2 transition-all rounded-lg cursor-pointer gap-x-3 items-center text-[#F5F5DC] font-medium text-xl"><svg xmlns="http://www.w3.org/2000/svg" fill="none"
            ...
            <li class="flex hover:bg-[#F5F5DC] hover:text-[#19559A] px-4 py-2 transition-all rounded-lg cursor-pointer gap-x-3 items-center text-[#F5F5DC] font-medium text-xl"><svg xmlns="http://www.w3.org/2000/svg" fill="none"
                ...
                Akademik</li>
            <li class="flex hover:bg-[#F5F5DC] hover:text-[#19559A] px-4 py-2 transition-all rounded-lg cursor-pointer gap-x-3 items-center text-[#F5F5DC] font-medium text-xl">
